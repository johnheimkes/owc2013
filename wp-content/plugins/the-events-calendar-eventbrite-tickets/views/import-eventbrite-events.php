...
<div class="wrap">
   ...
   <div>
			<?php _e('Your Eventbrite event id can be found by going to your event page at Eventbrite.com.  Once there, examine your browser\'s address bar to see something like this - https://www.eventbrite.com/event/212356789.  The number after \'/event/\' is your event id.', 'tribe-eventbrite'); ?>
   </div>
   <br/>
